package ch.app.test_qa.core.mobile;
...
public class AndroidDriverManager {
	...
	// # set YOUR device name into DEVICE_NAME global variable #
	private static final String DEVICE_NAME = "06208ec20ade96a0";

	public static RemoteWebDriver setUp() throws MalformedURLException {
